...
function renderConfig(orgId: string, values: ConfigValues): string {
  ...
  // The vendor supplying the base model: "anthropic", "openai", "openrouter",
  // "minimax-cn", "deepseek", "zai-coding-cn", "moonshotai-cn", or "aliyun"
  // (one key, many models). Naming one makes that
  // vendor's API key a required
